...
const CategoryProductPage = () => {
    ...
    const getProductByCategory = useCallback( async () => {
        try {
            const {data} = await axios.get(`${import.meta.env.VITE_API}/api/v1/product/category-product/${params.slug}`);
            ...
            <div className="row m-4">
                ...
                <div className="d-flex flex-wrap m-3 justify-content-center">
                    ...
                    <div className="card m-3" key={p._id} style={{width: '18rem'}}>
                        <img src={`${import.meta.env.VITE_API}/api/v1/product/product-photo/${p._id}`} height={300} className="card-img-top" alt={p?.name} />
